...
use SuperElf\Pool\Invitation as PoolInvitation;
...
class SyncService
{
    ...
    /**
     * @var PoolInvitationRepository
     */
    private $poolInvitationRepos;
    /**
     * @var Mailer
     */
    protected $mailer;
    ...
    public function __construct(
        ...
        PoolInvitationRepository $poolInvitationRepos,
        Mailer $mailer,
        Configuration $config
    ) {
        $this->userRepos = $userRepos;
        $this->poolUserRepos = $poolUserRepos;
        $this->poolInvitationRepos = $poolInvitationRepos;
        $this->mailer = $mailer;
        $this->config = $config;
    }
    ...
    /**
     * @param User $user
     * @param array | PoolInvitation[] $invitations
     * @return array | PoolUser[]
     */
