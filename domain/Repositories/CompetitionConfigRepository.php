 ...
 */
final class CompetitionConfigRepository extends EntityRepository
{
    ...
    {
        $period = Period::fromDate(new \DateTimeImmutable(), (new \DateTimeImmutable())->add(new \DateInterval('PT1S')));
