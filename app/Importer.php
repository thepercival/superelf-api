...
use App\SportsImportHelpers\AgainstGameImportHelper;
use App\SportsImportHelpers\AssociationImportHelper;
use App\SportsImportHelpers\CompetitionImportHelper;
use App\SportsImportHelpers\ExternalSourceGetter;
use App\SportsImportHelpers\LeagueImportHelper;
use App\SportsImportHelpers\PersonImportHelper;
use App\SportsImportHelpers\PlayerImportHelper;
use App\SportsImportHelpers\SeasonImportHelper;
use App\SportsImportHelpers\SportImportHelper;
use App\SportsImportHelpers\StructureImportHelper;
use App\SportsImportHelpers\TeamCompetitorImportHelper;
use App\SportsImportHelpers\TeamImportHelper;
use App\SportsImportHelpers\TransfersImportHelper;
...
final class Importer
{
    ...
    public function __construct(
        protected SportImportHelper          $sportImportService,
        protected AssociationImportHelper    $associationImportService,
        protected SeasonImportHelper         $seasonImportService,
        protected LeagueImportHelper         $leagueImportService,
        protected CompetitionImportHelper    $competitionImportService,
        protected TeamImportHelper           $teamImportService,
        protected TeamCompetitorImportHelper $teamCompetitorImportService,
        protected StructureImportHelper      $structureImportService,
        protected AgainstGameImportHelper    $againstGameImportService,
        protected PersonImportHelper         $personImportService,
        protected PlayerImportHelper         $playerImportService,
        protected TransfersImportHelper      $transfersImportService,
    ...
    public function importTeamTransfers(
        ExternSourceCompetitionsInterface $externalSourceCompetitions,
        ExternSourceCompetitionStructureInterface $externalSourceCompetitionStructure,
        ExternalSourceTransfersInterface $externalSourceTransfers,
        ExternalSource $externalSource,
        Sport $sport,
        League $league,
        Season $season,
    ...
    public function importAgainstGameBasicsLineupsAndEvents(
        ExternSourceCompetitionsInterface $externalSourceCompetitions,
        ExternSourceCompetitionStructureInterface $externalSourceCompetitionStructure,
        ExternalSourceGamesAndPlayersInterface $externalSourceCompetitionGames,
        ExternalSource $externalSource,
        Sport $sport,
        League $league,
        Season $season,
