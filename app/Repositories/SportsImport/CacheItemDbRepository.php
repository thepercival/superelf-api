...
namespace App\Repositories\SportsImport;

use DateTimeImmutable;
use Doctrine\ORM\EntityRepository;
use SportsImport\CacheItemDb;
use SportsImport\CacheItemDb\CacheItemDbRepositoryInterface;

/**
 * @api
 * @template-extends EntityRepository<CacheItemDb>
 */
final class CacheItemDbRepository extends EntityRepository implements CacheItemDbRepositoryInterface
{
    #[\Override]
    ...
    #[\Override]
    public function saveItem(string $name, mixed $value, int|null $nrOfMinutesToExpire = null): string
    {
        $cacheItem = $this->findOneBy(["name" => $name]);
        $expireDateTime = null;
