 ...
 * @api
 */
final class TeamCompetitorImportHelper
{
    /** @var EntityRepository<TeamCompetitorImportHelper> */
...
//        $metadata = $entityManager->getClassMetadata(TeamCompetitorImportHelper::class);
